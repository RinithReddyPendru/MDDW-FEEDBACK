  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-end justify-end animate-fade-in">
       <div className="relative group">
          ...
          <div className={`w-20 h-20 rounded-full border-4 border-white flex items-center justify-center cursor-pointer transition-all duration-500 ease-out relative ${containerClasses}`}>
            {/* Beautiful Lotus SVG */}
            <svg viewBox="0 0 100 100" className="w-12 h-12 relative z-10 drop-shadow-md transition-all duration-500">
              {/* Outer Petals */}
              <path d="M 50 90 C 20 90 10 60 10 50 C 30 50 40 70 50 90 Z" className={`${petalColor} transition-colors duration-500`} />
              <path d="M 50 90 C 80 90 90 60 90 50 C 70 50 60 70 50 90 Z" className={`${petalColor} transition-colors duration-500`} />
              
              {/* Middle Petals */}
              <path d="M 50 90 C 25 80 20 40 30 30 C 40 45 45 70 50 90 Z" className={`${centerColor} transition-colors duration-500`} />
              <path d="M 50 90 C 75 80 80 40 70 30 C 60 45 55 70 50 90 Z" className={`${centerColor} transition-colors duration-500`} />
